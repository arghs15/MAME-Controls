...
where the main app runs from the preview folder, with PyQt as default UI
"""
...
def main():
    ...
    try:
        ...
        parser.add_argument('--tkinter', action='store_true', help='Use the Tkinter version of the main GUI (default: PyQt)')
        ...
        if not args.tkinter:  # Changed condition to use PyQt by default
            ...
            try:
                ...
                args.tkinter = True  # Fall back to Tkinter if PyQt fails
