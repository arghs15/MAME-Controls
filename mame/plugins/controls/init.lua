...
function exports.startplugin()
    ...
    local function show_controls()
        ...
        if game_name and game_name ~= "" then
            -- Updated path to reference the exe in the preview folder directly
            -- Note: Current directory in MAME is the MAME root directory
            local command = string.format('"preview\\MAME Controls.exe" --preview-only --game %s --screen 1 --hide-joystick --hide-buttons', game_name)
